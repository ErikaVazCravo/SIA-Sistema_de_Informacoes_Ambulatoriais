#Automação criada renomear os arquivos gerados no 07a - Relatório Emissão Síntese da Produção - BPA por prestador
...
# Define o caminho do arquivo contendo os códigos e nomes
...
for nome_arquivo in os.listdir(pasta):
    if nome_arquivo.endswith(EXT):  # Filtra apenas arquivos com a extensão .DEZ
        ...
        if nome_base.startswith("RBPA_"):
            codigo = nome_base[5:12]
            sufixo = " - PRODUCAO BPA.txt"
        else:
